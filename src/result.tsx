      ...
      <div className={(store.completed && uiStore.searched) ? '' : 'hidden'} >
          ...
          <div className={store.empty ? 'hidden' : ''}>
            ...
            <div style={{"margin":"6px"}}>
              ...
              <br/><span>- Original ou cópia autenticada do Requerimento para Fiscalização de Produtos Agropecuários, emitido pelo MAPA;</span>
            </div>
            <div style={{"margin":"6px"}}>
              <span>3 – SE A PARTIDA JÁ FOI INTERNALIZADA PELO MAPA E ESTIVER SAINDO DO DESTINO DECLARADO NA IMPORTAÇÃO, EM DIREÇÃO A QUALQUER UF: </span> 
            ...
            <div style={{"margin":"6px"}}>
              <span>1 – SE A PARTIDA JÁ FOI EXPORTADA PELO MAPA EM ÁREA ALFANDEGADA NO INTERIOR DO BRASIL E ESTIVER EM TRÂNSITO A PONTO DE EGRESSO:</span> 
