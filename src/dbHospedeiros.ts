...
const hospedeiros: Hospedeiro[] = [
  ...
  { nomeVul: 'Bilimbi', nomeSci: 'Chrysophyllum cainito', count: 1 },
  ...
  { nomeVul: 'Carambola amarela', nomeSci: 'Chrysophyllum cainito', count: 1 },
  ...
  { nomeVul: 'Carvalho Vermelho do Norte(Q.borealis)', nomeSci: 'Quercus borealis (syn: rubra)', count: 1},
