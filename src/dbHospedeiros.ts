...
const hospedeiros: Hospedeiro[] = [
  ...
  { nomeVul: 'Cajá', nomeSci: 'Spondias lutea', count: 1 },
  { nomeVul: 'Cajá', nomeSci: 'Spondias mombin', count: 1 },
  { nomeVul: 'Cajá-mirim', nomeSci: 'Spondias lutea', count: 1 },
  { nomeVul: 'Cajá-mirim', nomeSci: 'Spondias mombin', count: 1 },
  { nomeVul: 'Cajazeiro', nomeSci: 'Spondias lutea', count: 1 },
  { nomeVul: 'Cajazeiro', nomeSci: 'Spondias mombin', count: 1 },
  ...
  { nomeVul: 'Taperebá', nomeSci: 'Spondias mombin', count: 1 },
