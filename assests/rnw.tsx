...
AppRegistry.registerComponent('Rnw', () => Rnw)

export default Rnw

/* AppRegistry.runApplication('Rnw', {
  rootTag: document.getElementById('rnw'),
}) */
...
/*    
const Component = () => import('./rnw')
const Rnw = React.lazy(Component)
